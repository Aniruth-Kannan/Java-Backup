...
public class seleniumMethods {
    ...
    public String returnAttributeValue(WebDriver driver, String xPath, String attribue){
        String attributeValue = driver.findElement(By.xpath(xPath)).getCssValue(attribue);
        return attributeValue;
    }

    public static void clickWithActions (WebDriver driver, String xPath){
        Actions actions = new Actions(driver);
