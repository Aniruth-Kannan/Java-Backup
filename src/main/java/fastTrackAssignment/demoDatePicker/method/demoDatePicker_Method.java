package fastTrackAssignment.demoDatePicker.method;

import fastTrackAssignment.commonMethods.commonMethods;
import org.openqa.selenium.By;
import org.openqa.selenium.WebDriver;

import static fastTrackAssignment.demoDatePicker.page.demoDatePicker_Page.*;

public class demoDatePicker_Method {

    static fastTrackAssignment.commonMethods.commonMethods commonMethods = new commonMethods();
    ...
    public static void selectDemoDatePickerEnabled(WebDriver driver, String expectedMonth, String expectedYr, String expectedDate){
        ...
        commonMethods.selectElementByName(driver, monthSelectDatePickerEnabled, expectedMonth);
        commonMethods.selectElementByName(driver, yearSelectDatePickerEnabled, expectedMonth);
